...
const processLabels = (labels) => {
	...
	result[labels.x[0].join(' ').toUpperCase()] = coords[0];
	result[labels.x[1].join(' ').toUpperCase()] = coords[1];
	result[labels.y[0].join(' ').toUpperCase()] = coords[2];
	result[labels.y[1].join(' ').toUpperCase()] = coords[3];
	result[labels.z[0].join(' ').toUpperCase()] = coords[4];
	result[labels.z[1].join(' ').toUpperCase()] = coords[5];
	return result;
}
